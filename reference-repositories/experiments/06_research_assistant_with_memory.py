#!/usr/bin/env python3
"""
Level 6: Research Assistant with Token-Aware Memory Management
Implements Pattern 4 from Dify: Intelligent conversation history pruning
"""
...
# =============================================================================
# PATTERN 4: TOKEN-AWARE MEMORY BUFFER
# =============================================================================

class TokenBufferMemory:
    """
    Manages conversation history within token limits.
    Implements Pattern 4 from Dify production patterns.
    """
    ...
    def _trim_to_limit(self):
        ...
        Always removes user+assistant pairs to maintain coherence.
        """
        while self._estimate_tokens() > self.max_tokens and len(self.messages) > 2:
            # Remove oldest pair (user question + assistant response)
            print(f"[MEMORY] Pruning old messages (current: ~{self._estimate_tokens()} tokens)")
            self.messages.pop(0)
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            "utilization": f"{(self._estimate_tokens() / self.max_tokens * 100):.1f}%"
        }
...
# =============================================================================
# API HELPER FUNCTIONS (Same as Level 5)
# =============================================================================
...
def research_assistant():
    """Main research assistant loop with memory management"""

    print("="*80)
    print("LEVEL 6: RESEARCH ASSISTANT WITH MEMORY MANAGEMENT")
    print("="*80)
    print("\nCapabilities:")
    ...
    print("\nMemory Management:")
    print("  - Automatic conversation pruning at 8000 tokens")
    print("  - Maintains recent context for coherence")
    print("  - Type 'stats' to see memory usage")
    print("\nType 'quit' to exit, 'stats' for memory stats, 'save' to save conversation\n")

    # Initialize memory buffer
    memory = TokenBufferMemory(max_tokens=8000)
    ...
    while True:
        ...
        if user_input.lower() == 'stats':
            ...
            print(f"  Estimated Tokens: {stats['estimated_tokens']} / {stats['max_tokens']}")
